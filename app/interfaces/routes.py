...
def init_app(app, jwt):
    ...
    def create_alarm():
        ...
        return jsonify({'alarm_id': alarm.id, 'asset': alarm.asset, 'target_price': alarm.target_price}), 201
    ...
    def get_alarms():
        ...
        alarms_data = [{'id': alarm.id, 'asset': alarm.asset, 'target_price': alarm.target_price} for alarm in alarms]
